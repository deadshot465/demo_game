...
impl Pipeline {
    ...
    pub fn create_renderpass(&mut self, graphics_format: Format, depth_format: Format, sample_count: SampleCountFlags) {
        ...
        let color_reference = AttachmentReference::builder()
            .attachment(0)
        ...
        let resolve_reference = AttachmentReference::builder()
            .attachment(2)
            .layout(ImageLayout::COLOR_ATTACHMENT_OPTIMAL)
            .build();
        ...
        let subpass_description = SubpassDescription::builder()
            ...
            .resolve_attachments(&[resolve_reference])
            .build();
    ...
    pub async fn create_graphic_pipelines(&mut self, descriptor_set_layout: &[DescriptorSetLayout],
        ...
        unsafe {
            for i in 0..BlendMode::END.0 {
                let color_attachment = PipelineColorBlendAttachmentState::builder()
                ...
                worker_threads.push(
                    tokio::spawn(async move {
                        ...
                        let binding_desc = Vertex::get_binding_description(0, VertexInputRate::VERTEX);
