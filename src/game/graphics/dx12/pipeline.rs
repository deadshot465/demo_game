...
impl Pipeline {
    ...
    pub unsafe fn create_root_signature(
        ...
        log_error(
            res,
            "Current device doesn't support required root signature.",
        );
        ...
        parameter_1.u.DescriptorTable_mut().NumDescriptorRanges = vs_descriptor_range.len() as UINT;
        parameter_1.u.DescriptorTable_mut().pDescriptorRanges = vs_descriptor_range.as_ptr();
        ...
        parameter_2.u.DescriptorTable_mut().pDescriptorRanges = ps_descriptor_range.as_ptr();
        parameter_2.u.DescriptorTable_mut().NumDescriptorRanges = ps_descriptor_range.len() as UINT;
        ...
        *constant = root_constant;
        ...
        res = device.CreateRootSignature(
            0,
            ref_1.as_ref().unwrap().GetBufferPointer(),
            ref_1.as_ref().unwrap().GetBufferSize(),
